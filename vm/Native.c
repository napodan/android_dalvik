...
static bool checkOnLoadResult(SharedLib* pEntry)
{
    ...
    ALOGV("+++ retrieving %s OnLoad status\n", pEntry->pathName);
    bool result;
...
#define LOGI_NATIVE(...) ALOG(LOG_INFO, LOG_TAG "-native", __VA_ARGS__)
